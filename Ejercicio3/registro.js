...
var RegistroAutomotor = /** @class */ (function () {
    ...
    RegistroAutomotor.prototype.modificarModeloMoto = function (dominio, nuevoModelo) {
        var moto = this.listMoto.find(function (m) { return m.getDominio() === dominio; });
        if (moto) {
            moto.setModelo(nuevoModelo);
            console.log("El modelo de la moto con dominio ".concat(dominio, " ha sido actualizado a ").concat(nuevoModelo, "."));
        }
        else {
            console.log("No se encontr\u00F3 una moto con el dominio ".concat(dominio, "."));
        }
